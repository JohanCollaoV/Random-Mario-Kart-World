...
let mostrarHelados = false;

function mostrarImagen(index){
  mostrarHelados = false;
  ...
  previewBox.style.cursor = (modoAlternativo && pista.nombre === 'Cielos Helados') ? 'pointer' : '';
}
...
selectedPreview.addEventListener('click', function(){
  ...
  if (pista.nombre !== 'Cielos Helados') return;
  mostrarHelados = !mostrarHelados;
  preview.classList.remove('loaded');
  if (mostrarHelados) {
    preview.alt = 'Helados';
    previewLabel.textContent = 'Helados';
    const src = 'assets/images/tracks/mcflurry.png';
    preview.onload = () => { preview.classList.add('loaded'); };
    preview.onerror = () => {};
    preview.src = src;
  } else {
    preview.alt = 'Cielos';
    previewLabel.textContent = 'Cielos';
    const src = 'assets/images/tracks/Cielos%20Helados.png';
    preview.onload = () => { preview.classList.add('loaded'); };
    preview.onerror = () => {};
    preview.src = src;
  }
